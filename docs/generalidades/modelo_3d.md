...
Los modelos se traducen en archivos. Su exportación se trata en [BIM Publisher](bim_publisher.md). Se describen debajo los directorios actuales que tiene cada proyecto a nivel maqueta y para que sirve cada uno.
