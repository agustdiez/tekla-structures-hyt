...
{: .warning}
>La visibilidad de los objetos estará supeditada a la profundidad a la que se haya modelado, y en la ubicación en que se encuentren, por lo que deberá ajustarse estos parámetros de la vista para que aparezcan en la solapa de visibilidad.
