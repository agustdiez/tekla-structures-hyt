...
{: .note}
> - La altura de los textos se adoptan de los parámetros del archivo de texto importado, pero puede escalarse según se necesite desde este programa, aunque es recomendable editar el tamaño desde el archivo original.
> 
> - Al hacer doble click en el texto se abrirá el documento para ser editado, no las propiedades. En este caso las propiedades se abriran con el click derecho y `Properties...`

{: .important}
> Los textos enriquecidos de la empresa se verán en nuestro dibujo de la siguiente manera:
