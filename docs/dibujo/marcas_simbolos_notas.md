...
|-------------------|-----------------|--------|
| Perfil metálico | <img src="../img/dibujo/P.M.%20PERFIL%20OUTPUT.png" width="800">| <img src="../img/dibujo/P.M. PERFIL.png" width="200">|
| Perfil metálico + símbolo | <img src="../img/dibujo/P.M.%20PERFIL%20+%20simbolo%20OUTPUT.png" width="800">  |  <img src="../img/dibujo/P.M. PERFIL + simbolo.png" width="200">|
| Dimensión de pedestal + nombre | <img src="../img/dibujo/ejemplo%20pedestal%20configuración.png" width="800"> |<img src="../img/dibujo/ejemplo%20pedestal%20output.png" width="200">|
| Marca de anclaje | <img src="../img/dibujo/ejemplo%20marca%20anclaje.png" width="800"> |<img src="../img/dibujo/output%20marca%20anclaje.png" width="200">|
| Marca de coordenada | <img src="../img/dibujo/coordenada part mark.png" width="800"> |<img src="../img/dibujo/output part mark coord.png" width="200">|

{: .note}
>- Tener en cuenta que estas marcas pueden realizarse tanto como una `Note` como con un `Text` y debe referenciar a una parte modelada si o si.
>- Para ejemplo de part mark con armadura ver ["Marcas armadura utilizando part mark"](../dibujo/marcas_simbolos_notas.md#utilizando-part-mark).
...
> Importante: Las marcas de nivel de la empresa se verán en nuestro dibujo de la siguiente manera:
    ![marca nivel empresa](../img/dibujo/marca%20nivel%20empresa.png)
...
> Importante: Las marcas de sección de la empresa se verán en nuestro dibujo de la siguiente manera:
    ![marca seccion empresa](../img/dibujo/marca%20seccion%20empresa.png)
...
> Importante: Las marcas de detalle de la empresa se verán en nuestro dibujo de la siguiente manera:
    ![marca detalle empresa](../img/dibujo/marca%20detalle%20empresa.png)
...
>![combinar dimension cotas](../img/dibujo/combinar%20dimension%20cotas.gif)
*Figura 19: Unir cotas*
>![separar dimension cotas](../img/dibujo/separar%20dimension%20cotas.gif)
*Figura 20: Separar cotas*

### Propiedades

![Propiedades general de cota](../img/dibujo/Propiedades%20general%20de%20cota.png)
*Figura 21: Propiedades general de cota*
...
*Figura 22: Propiedades appeareance de cota*
...
*Figura 23: Propiedades marks de cota*
...
*Figura 24: Propiedades tags de cota*
...
*Figura 25: Ejemplo colocar `Note`*

### Propiedades:

![propiedades notas](../img/dibujo/propiedades%20notas.png)
*Figura 26:  Configuración en "Content"*
...
> Importante: Las notas de la empresa se verán en nuestro dibujo de la siguiente manera:
    ![notas empresa](../img/dibujo/notas%20empresa.png)
...
*Figura 29: Ejemplo Tip 1*

![ejemplo no frame](../img/dibujo/ejemplo%20no%20frame.gif)
*Figura 30: Ejemplo Tip 2*

> Importante: Los textos de la empresa se verán en nuestro dibujo de la siguiente manera:
    ![texto empresa](../img/dibujo/texto%20empresa.png)
...
*Figura 31: Ejemplo `Rich text`*`

{: .note}
>Aclaración 1: La altura de los textos se adoptan de los parámetros del archivo de texto importado, pero puede escalarse según se necesite desde este programa, aunque es recomendable editar el tamaño desde el archivo original.
> Aclaración 2: Al hacer doble click en el texto se abrirá el documento para ser editado, no las propiedades. En este caso las propiedades se abriran con el click derecho y `Properties...`

> Importante: Los textos enriquecidos de la empresa se verán en nuestro dibujo de la siguiente manera:
    ![texto enriquecido tekla](../img/dibujo/texto%20enriquecido%20tekla.png)
...
*Figura 32: Selección de simbolos*
...
*Figura 33: Apariencia de simbolos*
...
*Figura 34: Propiedades editor de simbolos*
...
*Figura 35: Panel de importación de archivos ".dwg"*
...
*Figura 36: Ejemplo de colocación de simbolo en base a un archivo ".dwg"*
...
*Figura 37: Propiedades generales de barras*
...
*Figura 38: Propiedades de apariencia de barras*
...
{: .highlight}
> Si se colocará unicamente una barra en el dibujo, para moverse se debe hacer click derecho en ella y seleccionar `Adjust location` ![adjust location barras](../img/dibujo/adjust%20location%20barras.png) 
...
*Figura 39: Ejemplo de colocación marca armadura con componente*
...
*Figura 40: Marca grupo de barras (Geometry)*
...
*Figura 41: Marca grupo de barras (Mark 1)*
...
*Figura 42: Marca grupo de barras (Lines and symbol)* 
...
*Figura 43: Marca grupo de barras (Symbols on rebars)*
...
*Figura 44: Ejemplo de marca de grupo de barras en un plano*
...
*Figura 45: Ejemplo Part mark en barra individual.
